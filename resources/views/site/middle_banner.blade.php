...
@section('content')
    ...
    <div style="background: url({{ asset('storage/'.$middle_banner->details_background_image1) }}) !important;
        ...
        height: 550px;" class=" d-flex w-100 p-3 mx-auto flex-column news-cover-container main-middleBanner">
    ...
    <div class="newsSection middleBanner">



        <div class="container-fluid-sm text-center title" data-aos-easing="linear" data-aos="zoom-in-up"
                            ...
                            <div class="news-padding">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-sm-6 text-section" data-aos-easing="linear" data-aos="zoom-in-left"
                            ...
                            <div class="news-padding">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 text-section " data-aos-easing="linear" data-aos="zoom-in-right"
        ...
        <div class="newsSection-second engagementSection mb-5 lida-area-middle">
                ...
                <div class="news-padding">
                    ...
                    <div class="container">
                        ...
                        <div class=" text-center">
                            ...
                            <h3 class=" text-dark mb-5 pb-5">THREE PRODUCTS ARE LAUNCHING DURING GITEX 2022</h3>
                                    ...
                                    <div class="EngagementActive">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12  mb-5">
                                                ...
                                                <img src="{{asset('storage/'.$value->image)}}" class="thumblida"/>

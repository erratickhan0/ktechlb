            ...
            <div class="header-body">
                <div class="row align-items-center py-6">
                    ...
                    <div class="col-lg-6 col-5 mt-2 text-right">
                        <a href="{{ route('admin.p2-slide-changer3.create',['p2' => $p2->id]) }}" class="btn btn-primary">Create new Slide Changer page</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                                ...
                                <tbody>
                                @foreach($p2->slide_changer_3 ?? []  as $slide)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="nav-item dropdown text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" >
                                                    <a class="dropdown-item" href="{{ route('admin.p2-slide-changer3.edit', [$slide->id, 'p2' => $slide->p2_id]) }}">Edit</a>
                                                    <a href="javascript:;"
                                                       class="dropdown-item"
                                                       data-toggle="modal"
                                                       data-target="#confirm_delete"
                                                       data-action="{{ route('admin.p2-slide-changer3.destroy',[$slide->id, 'p2' => $slide->p2_id] ) }}"

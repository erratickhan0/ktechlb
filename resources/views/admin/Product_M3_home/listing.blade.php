            ...
            <div class="header-body">
                <div class="row align-items-center py-6">
                    ...
                    <div class="col-lg-6 col-5 mt-2 text-right">
                        <a href="{{ route('admin.mybrand.product-m3.create') }}" class="btn btn-primary">Create new product</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                               ...
                               <tr>
                                        <td class="align-middle name mb-0 text-sm">{{$product->description}}</td>
                                        <td class="align-middle">

                                            <img width="100px" height="70px" src="{{asset('storage/'.$product->image1)}}" />
                                        </td>
                                        @if(!$product->single_image)
                                       <td class="align-middle">

                                           <img width="100px" height="70px" src="{{asset('storage/'.$product->image2)}}" />
                                       </td>
                                        @endif
                                        <td class="text-right">
                                            <div class="nav-item dropdown text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" >
                                                    <a href="javascript:;"
                                                       ...
                                                       data-action="{{ route('admin.mybrand.product-m3.delete',['product' =>$product->id] ) }}"

                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active"><a href="#">News Section</a></li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                               ...
                               <tr>
                                        <td class="align-middle name mb-0 text-sm">{{$news->title}}</td>
                                        <td class="align-middle">{{$news->created_at}}</td>

                                        <td class="align-middle">
                                            <img width="100px" height="70px" src="{{asset('storage/'.$news->image)}}" />
                                        </td>
                                        <td class="text-right">

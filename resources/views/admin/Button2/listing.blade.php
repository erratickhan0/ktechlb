                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Button2 Section</a></li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                                ...
                                <tbody>
                                @foreach($button2 ?? []  as $page)
                                    <tr>
                                        <td class="align-middle name mb-0 text-sm">{{$page->id}}</td>
                                        <td class="align-middle name mb-0 text-sm">{{$page->title}}</td>
                                        <td class="align-middle">{{$page->subtitle}}</td>
                                        <td class="align-middle">
                                        <img width="100px" height="70px" src="{{asset('storage/'.$page->image1)}}" />
                                        </td>
                                        <td class="align-middle">
                                            <img width="100px" height="70px" src="{{asset('storage/'.$page->image2)}}" />
                                        </td>
                                        <td class="text-right">
                                            <div class="nav-item dropdown text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" >
                                                    <a class="dropdown-item" href="{{ route('admin.button2-slide-changer.index',['button2' => $page->id]) }}">Slide Changer</a>
                                                    <a class="dropdown-item" href="{{ route('admin.button2.edit', $page->id) }}">Edit</a>
                                                    <a href="javascript:;"
                                                       class="dropdown-item"
                                                       data-toggle="modal"
                                                       data-target="#confirm_delete"
                                                       data-action="{{ route('admin.button2.destroy',$page->id ) }}"

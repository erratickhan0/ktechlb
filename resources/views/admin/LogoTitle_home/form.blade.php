                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group required">
                                            ...
                                            {{ Form::text('title1', $logo_title->title1, array('class' => 'form-control')) }}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group required">
                                            ...
                                            {{ Form::text('title2', $logo_title->title2, array('class' => 'form-control')) }}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group required">
                                            ...
                                            {{ Form::textarea('description', $logo_title->description, array('class' => 'form-control wysiwyg','rows' => 6, 'cols' => 40)) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">

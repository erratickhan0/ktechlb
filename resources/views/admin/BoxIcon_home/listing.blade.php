                ...
                <div class="row align-items-center py-6">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">
                            <span>Box Icon Section</span>
                            <small class="badge badge-light ml-1">Total</small>
                        </h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item active"><a href="#">Box Icon Section</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 mt-2 text-right">
                        <a href="{{ route('admin.mybrand.box-icon.create') }}" class="btn btn-primary">Create new Box Icon</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                                ...
                                <tbody>
                                @foreach($box_icon ?? []  as $box_icon)
                               <tr>
                                        <td class="align-middle name mb-0 text-sm">{{$box_icon->title}}</td>
                                        <td class="align-middle">{{$box_icon->created_at}}</td>

                                        <td class="align-middle">
                                            <img width="100px" height="70px" src="{{asset('storage/'.$box_icon->box_icon)}}" />
                                        </td>
                                        <td class="text-right">
                                            <div class="nav-item dropdown text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" >
                                                    <a href="javascript:;"
                                                       ...
                                                       data-action="{{ route('admin.mybrand.box-icon.delete',['box_icon' =>$box_icon->id] ) }}"

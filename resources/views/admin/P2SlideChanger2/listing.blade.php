                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active"><a href="#">p2 Slide Changer Section</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 mt-2 text-right">
                        <a href="{{ route('admin.p2-slide-changer2.create',['p2' => $p2->id]) }}" class="btn btn-primary">Create new Slide Changer page</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center">
                                ...
                                <tbody>
                                @foreach($p2->slide_changer_2 ?? []  as $slide)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <img width="100px" alt="Image not found" height="70px" src="{{asset('storage/'.$slide->bg_image)}}" />
                                        </td>
                                        <td class="text-right">
                                            <div class="nav-item dropdown text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" >
                                                    <a class="dropdown-item" href="{{ route('admin.p2-slide-changer2.edit', [$slide->id, 'p2' => $slide->p2_id]) }}">Edit</a>
                                                    <a href="javascript:;"
                                                       class="dropdown-item"
                                                       data-toggle="modal"
                                                       data-target="#confirm_delete"
                                                       data-action="{{ route('admin.p2-slide-changer2.destroy',[$slide->id, 'p2' => $slide->p2_id] ) }}"

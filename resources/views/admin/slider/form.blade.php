...
@section('content')
        {{ Form::open(['route' => ['admin.mybrand.slider.store',['slug' => $slug]], 'role' => 'form', 'id' => 'slider-form', 'files' => true]) }}
                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.mybrand.slider',['slug' => $slug]) }}">Slider</a></li>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <a href="{{ route('admin.mybrand.slider',['slug' => $slug]) }}" class="btn btn-s btn-outline-primary">Cancel</a>
                                    </div>
                                </div>
